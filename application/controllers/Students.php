...
class Students extends Admin_Controller 
{
	...
	public function index()
	{
		...
		if(!in_array('viewStudent', $this->permission)) {
		 ...
		 $this->data['js'] = 'application/views/students/index-js.php';
		$stud_data = $this->model_students->getStudentData();
		...
		foreach ($stud_data as $k => $v) {
			...
			//$group = $this->model_students->getUserGroup($v['id']);
	...
	public function create()
	{
		...
		if(!in_array('createUser', $this->permission)) {
		 ...
		 $this->data['js'] = 'application/views/users/create-js.php';
	...
	public function edit($id = null)
	{
		...
		if(!in_array('updateUser', $this->permission)) {
		 ...
		 $this->data['js'] = 'application/views/users/edit-js.php';
		if($id) {
			$this->form_validation->set_rules('groups', 'Group', 'required');
			$this->form_validation->set_rules('store', 'Store', 'trim|required');
	...
	public function delete($id)
	{
		...
		if(!in_array('deleteUser', $this->permission)) {
 		...
 		$this->data['js'] = 'application/views/users/delete-js.php';
		if($id) {
	...
	public function profile()
	{
		...
		if(!in_array('viewProfile', $this->permission)) {
		 ...
		 $this->data['js'] = 'application/views/users/profile-js.php';
	...
	public function setting()
	{
		...
		$id = $this->session->userdata('id');
		 $this->data['js'] = 'application/views/users/setting-js.php';
		if($id) {
			$this->form_validation->set_rules('username', 'Username', 'trim|required|min_length[5]|max_length[12]');
			$this->form_validation->set_rules('email', 'Email', 'trim|required');
			$this->form_validation->set_rules('fname', 'First name', 'trim|required');
