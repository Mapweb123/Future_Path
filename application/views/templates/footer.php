<footer class="footer">
    ...
    <div class="dropdown show-dropdown">
      ...
      <ul class="dropdown-menu">
        ...
        <li class="adjustments-line">
          <a href="javascript:;" class="switch-trigger active-color">
  ...
  <script src="<?php echo base_url('assets/material-dashboard/');?>assets/js/material-dashboard.js?v=2.1.2" type="text/javascript"></script>
